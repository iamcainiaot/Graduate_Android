 ...
 * @description 描述
 */
public class FillScreenButton extends Button {
    private int width;
    private int heigh;
    ...
    public FillScreenButton(Context context) {
        super(context);
        init(context);
    }

    public FillScreenButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public FillScreenButton(Context context, AttributeSet attrs, int defStyleAttr) {
