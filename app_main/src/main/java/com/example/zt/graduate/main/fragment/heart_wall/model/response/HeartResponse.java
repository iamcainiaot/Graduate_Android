package com.example.zt.graduate.main.fragment.heart_wall.model.response;
 ...
 * @description 心声墙响应数据
 */
public class HeartResponse extends BaseResponse implements Parcelable {
    /**
     * 心声id
     */
     ...
     * 实现Parcel 接口
     */
    protected HeartResponse(Parcel in) {
    ...
    public static final Creator<HeartResponse> CREATOR = new Creator<HeartResponse>() {
        @Override
        public HeartResponse createFromParcel(Parcel in) {
            return new HeartResponse(in);
        }

        @Override
        public HeartResponse[] newArray(int size) {
            return new HeartResponse[size];
        }
    };
